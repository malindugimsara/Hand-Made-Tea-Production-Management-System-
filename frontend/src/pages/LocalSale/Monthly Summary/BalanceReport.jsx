    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] p-4 md:p-8 font-sans">
            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-6">
                ...
                {/* ========================================================================= */}
                {analysis.hasData && (
                    <div className={`p-5 rounded-2xl border transition-all duration-300 shadow-sm ${analysis.isOverdue
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                            ...
                            <div className="flex items-start gap-3.5">
                                <div className={`p-2.5 rounded-xl mt-0.5 ${analysis.isOverdue ? 'bg-red-600 text-white animate-pulse' : 'bg-emerald-600 text-white'
                                    }`}>
                                    {analysis.isOverdue ? <AlertTriangle className="w-6 h-6" /> : <CheckCircle2 className="w-6 h-6" />}
                                </div>
                                <div>
                                    <div className="flex items-center gap-2">
                                        <h3 className={`text-base font-black uppercase tracking-wide ${analysis.isOverdue ? 'text-red-700' : 'text-emerald-800'
                                            }`}>
                            ...
                            <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                                ...
                                {/* Difference / Variance */}
                                <div className={`px-3.5 py-2 rounded-xl text-center flex-1 sm:flex-none min-w-[110px] text-white font-bold ${analysis.isOverdue ? 'bg-red-600' : 'bg-emerald-600'
                                    }`}>
