...
export default function GreenLeafMonthlyReport() {
  ...
  const t = {
    ...
    reportTitle2: (m) => lang === 'SI' ? `අමු තේ වල ගුණාත්මය ඇගයීම පිළිබඳ වාර්තාව - ${m} මාසය` : `Green Leaf Quality Evaluation Report - ${m}`,
    ...
    avgThisMonth: lang === 'SI' ? "මෙම මාසයේ සාමාන්‍යය :" : "This Month Average :",
    ...
    <div className="p-4 sm:p-8 max-w-[1400px] mx-auto min-h-screen bg-[#f8fafc] dark:bg-zinc-950 font-sans transition-colors">
      ...
      <div className="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-zinc-900 p-5 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#1B6A31] hover:bg-[#145325] text-white rounded-xl font-bold text-sm flex items-center gap-2 transition-all shadow-sm disabled:opacity-50"
          >
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 overflow-hidden">
            ...
            <table className="w-full text-sm text-center border-collapse">
              <thead>
                <tr className="bg-[#f8fafc] dark:bg-zinc-950/50">
                  <th rowSpan={2} className="p-4 font-extrabold text-gray-700 dark:text-gray-300 border-b border-r border-gray-200 dark:border-zinc-800 text-left min-w-[120px]">{t.route}</th>
                  <th rowSpan={2} className="p-4 font-extrabold text-[#1B6A31] border-b border-r border-gray-200 dark:border-zinc-800">{t.rank}</th>
                  <th colSpan={3} className="p-3 font-extrabold text-gray-600 dark:text-gray-400 border-b border-r border-gray-200 dark:border-zinc-800 bg-[#f1f5f9] dark:bg-zinc-800">{t.qualityDist}</th>
                  <th colSpan={3} className="p-3 font-extrabold text-gray-600 dark:text-gray-400 border-b border-r border-gray-200 dark:border-zinc-800 bg-[#f1f5f9] dark:bg-zinc-800">Weights (KG)</th>
                ...
                <tr className="text-[12px]">
                  <th className="p-3 font-bold text-blue-700 bg-blue-50/50 dark:bg-blue-950/20 border-b border-r border-gray-200 dark:border-zinc-800">{t.best}</th>
                  <th className="p-3 font-bold text-yellow-700 bg-yellow-50/50 dark:bg-yellow-950/20 border-b border-r border-gray-200 dark:border-zinc-800">{t.belowBest}</th>
                  <th className="p-3 font-bold text-red-700 bg-red-50/50 dark:bg-red-950/20 border-b border-r border-gray-200 dark:border-zinc-800">{t.poor}</th>
                  
                  <th className="p-3 font-bold text-green-700 bg-green-50/50 dark:bg-green-950/20 border-b border-r border-gray-200 dark:border-zinc-800">{t.currMonth}<br/><span className="text-[10px] text-green-600/70">{lang === 'SI' ? reportData.currMonthNameSI : reportData.currMonthNameEN}</span></th>
                  <th className="p-3 font-bold text-gray-600 bg-gray-50/50 dark:bg-zinc-800/50 border-b border-r border-gray-200 dark:border-zinc-800">{t.prevMonth}<br/><span className="text-[10px] text-gray-500/70">{lang === 'SI' ? reportData.prevMonthNameSI : reportData.prevMonthNameEN}</span></th>
                  <th className="p-3 font-bold text-gray-700 bg-gray-100/50 dark:bg-zinc-800 border-b border-r border-gray-200 dark:border-zinc-800">{t.diff}</th>
                  
                  <th className="p-3 font-bold text-red-600 bg-red-50/50 dark:bg-red-950/20 border-b border-r border-red-100 dark:border-red-900/50">{t.manual1}</th>
                  <th className="p-3 font-bold text-red-600 bg-red-50/50 dark:bg-red-950/20 border-b border-red-100 dark:border-red-900/50">{t.manual2}</th>
                </tr>
              </thead>
              <tbody>
                {[...reportData.currentStats.items].sort((a,b) => a.rank - b.rank).map((it) => {
                    ...
                    return (
                        <tr key={it.routeKey} className="border-b border-gray-100 dark:border-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                            <td className="p-3 text-left font-bold text-gray-700 dark:text-gray-300 border-r border-gray-100 dark:border-zinc-800 pl-4">{it.displayName}</td>
                            
                            <td className="p-3 border-r border-gray-100 dark:border-zinc-800">
                            ...
                            <td className="p-3 font-bold text-blue-700 dark:text-blue-400 border-r border-gray-100 dark:border-zinc-800 bg-blue-50/10">{it.bestPct}</td>
                            <td className="p-3 font-bold text-yellow-600 dark:text-yellow-500 border-r border-gray-100 dark:border-zinc-800 bg-yellow-50/10">{it.bbPct}</td>
                            <td className="p-3 font-bold text-red-600 dark:text-red-500 border-r border-gray-100 dark:border-zinc-800 bg-red-50/10">{it.poorPct}</td>

                            <td className="p-3 font-black text-gray-800 dark:text-gray-200 border-r border-gray-100 dark:border-zinc-800 text-right pr-4 bg-green-50/10">{formatNumber(it.totalKg)}</td>
                            <td className="p-3 font-semibold text-gray-500 dark:text-gray-400 border-r border-gray-100 dark:border-zinc-800 text-right pr-4">{formatNumber(prevKg)}</td>
                            <td className={`p-3 font-bold border-r border-gray-100 dark:border-zinc-800 text-right pr-4 ${diff > 0 ? 'text-green-600' : diff < 0 ? 'text-red-500' : 'text-gray-400'}`}>
          ...
          {/* Summary Footer */}
          <div className="bg-[#f8fafc] dark:bg-zinc-950 p-6 border-t border-gray-200 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-center gap-6">
    ...
    {/* ========================================================================================= */}
      ...
      >
          ...
          <div id="pdf-page-1" ref={page1Ref} className="p-10 font-sans flex flex-col justify-between" style={{ backgroundColor: '#ffffff', color: '#000000', width: '1123px', minHeight: '794px' }}>
              ...
              <div className="flex justify-between items-start mb-8 border-b-2 pb-6" style={{ borderColor: '#000000' }}>
                  <div className="flex items-center gap-6">
                      <img src="/logo.png" alt="Logo" className="w-24 h-24 object-contain" onError={(e) => e.target.style.display = 'none'} />
                      <div className="text-left">
                          <h1 className="text-3xl font-bold uppercase" style={{ color: '#166534', fontFamily: 'sans-serif' }}>
                              Athukorala Group (Pvt) Ltd
                          </h1>
                          {/* 💡 reportTitle1, reportTitle2 (මාසය) සහ අවුරුද්ද (Year) එකම පේළියට ගෙන ඇත */}
                          <h2 className="text-2xl font-bold mt-2" style={{ fontFamily: 'Iskoola Pota, sans-serif' }}>
                              {t.reportTitle1} - {t.reportTitle2(lang === 'SI' ? reportData?.currMonthNameSI : reportData?.currMonthNameEN)} {reportData?.year}
                          </h2>
                      </div>
                  </div>
                  <div className="text-right text-sm flex flex-col gap-1.5 pt-2" style={{ fontFamily: 'sans-serif', color: '#374151' }}>
                      <p><strong>{t.docRef}:</strong> {uniqueCode}</p>
                      <p><strong>{t.genTime}:</strong> {generatedDateTime}</p>
                  </div>
              </div>

              <table className="w-full border-collapse text-center text-[15px]" style={{ border: '1px solid #000000' }}>
                  <thead>
                      <tr className="pdf-bg-gray">
                          <th className="border p-2 font-extrabold text-left pl-4 w-[16%]" style={{ borderBottom: 'none' }}>{t.route}</th>
                          <th colSpan={3} className="border p-2 font-extrabold w-[21%]">{t.qualityDist}</th>
                          <th colSpan={3} className="border p-2 font-extrabold w-[43%]">Weights (KG)</th>
                          <th colSpan={2} className="border p-2 font-extrabold pdf-text-red w-[20%]">Manual Inputs</th>
                      </tr>
                      <tr className="pdf-bg-light text-[13px]">
                          <th className="border p-2" style={{ borderTop: 'none' }}></th>
                          <th className="border p-2 font-bold w-[7%] pdf-text-blue">{t.best}</th>
                          <th className="border p-2 font-bold w-[7%] pdf-text-yellow">{t.belowBest}</th>
                          <th className="border p-2 font-bold w-[7%] pdf-text-red">{t.poor}</th>
                          
                          <th className="border p-2 font-bold w-[15%] pdf-text-green">{t.currMonth}</th>
                          <th className="border p-2 font-bold w-[14%] pdf-text-dark">{t.prevMonth}</th>
                          <th className="border p-2 font-bold w-[14%]" style={{ color: '#1f2937' }}>{t.diff}</th>
                          
                          <th className="border p-2 font-bold w-[10%] pdf-text-red">{t.manual1}</th>
                          <th className="border p-2 font-bold w-[10%] pdf-text-red">{t.manual2}</th>
                      </tr>
                  </thead>
                  <tbody>
                      {reportData && [...reportData.currentStats.items].sort((a,b) => a.rank - b.rank).map((it) => {
                          ...
                          return (
                              <tr key={`pdf-${it.routeKey}`}>
                                  <td className="border p-2 font-bold text-left pl-4">{it.displayName}</td>
                                  ...
                                  <td className="border p-2 font-black text-right pr-4">{formatNumber(it.totalKg)}</td>
                                  <td className="border p-2 font-bold pdf-text-gray text-right pr-4">{formatNumber(prevKg)}</td>
                                  <td className="border p-2 font-bold text-right pr-4" style={{ color: diff > 0 ? '#16a34a' : diff < 0 ? '#dc2626' : '#6b7280' }}>{formatDiff(it.totalKg, prevKg)}</td>
                                  
                                  <td className="border p-2 font-bold pdf-text-red pdf-bg-red">{col1Val}</td>
                                  <td className="border p-2 font-bold pdf-text-red pdf-bg-red">{col2Val}</td>
                              </tr>
                          );
                      })}
                      ...
                      {reportData && (
                          <tr className="pdf-bg-yellow">
                              <td className="border p-3 font-extrabold text-left pl-4 italic">{t.avgThisMonth}</td>
                              ...
                              <td className="border p-3 font-black text-right pr-4 text-lg pdf-bg-green" style={{ color: '#14532d' }}>{formatNumber(reportData.currentStats.grandTotal)}</td>
                              <td className="border p-3 font-bold text-right pr-4 pdf-text-dark">{formatNumber(reportData.prevStats.grandTotal)}</td>
                              <td className="border p-3 font-bold text-right pr-4">{formatDiff(reportData.currentStats.grandTotal, reportData.prevStats.grandTotal)}</td>
              ...
              <div className="mt-8 mb-4 flex justify-between items-end px-12 text-center font-bold text-[14px] leading-relaxed">
                  <div className="w-56 flex flex-col items-center">
                      <div className="w-full border-t-[1.5px] mb-1.5" style={{ borderColor: '#000000' }}></div>
          ...
          <div id="pdf-page-2" ref={page2Ref} className="p-10 font-sans flex flex-col justify-between" style={{ backgroundColor: '#ffffff', color: '#000000', width: '1123px', minHeight: '794px' }}>
              ...
              <div className="flex justify-between items-start mb-8 border-b-2 pb-6" style={{ borderColor: '#000000' }}>
                  <div className="flex items-center gap-6">
                      ...
                      <div className="text-left">
                          ...
                          <h2 className="text-2xl font-bold mt-2" style={{ fontFamily: 'Iskoola Pota, sans-serif' }}>
                              {t.reportTitle1} - {t.reportTitle2(lang === 'SI' ? reportData?.currMonthNameSI : reportData?.currMonthNameEN)}
                          </h2>
                          <h3 className="text-2xl font-black mt-1">
                              {reportData?.year}
                          </h3>
                          <p className="text-lg font-bold mt-3 uppercase pdf-text-gray" style={{ fontFamily: 'Iskoola Pota, sans-serif' }}>
                              {t.reportTitle3}
                          </p>
                      </div>
                  </div>
              ...
              <div className="flex-grow flex items-start justify-center mt-4">
                  <table className="w-[50%] border-collapse text-center text-[18px]" style={{ border: '2px solid #000000' }}>
                      <thead>
                          <tr>
                              <th className="border p-3 font-black text-left pl-6 w-[40%]">SUPPLIER</th>
                              <th className="border p-3 font-black">B</th>
                              <th className="border p-3 font-black">B/B</th>
                              <th className="border p-3 font-black">P</th>
                          </tr>
                      </thead>
                      <tbody>
                          {reportData && routeOptions.map((r) => {
                              ...
                              return (
                                  <tr key={`page2-${r.key}`}>
                                      <td className="border p-3 font-bold text-left pl-6 pdf-text-gray">{r.display}</td>
                                      <td className="border p-3 font-bold" style={{ color: '#1f2937' }}>{stat ? stat.bestPct : "-"}</td>
                                      <td className="border p-3 font-bold" style={{ color: '#1f2937' }}>{stat ? stat.bbPct : "-"}</td>
                                      <td className="border p-3 font-bold" style={{ color: '#1f2937' }}>{stat ? stat.poorPct : "-"}</td>
                                  </tr>
                              );
                          })}
                          {reportData && (
                              <tr className="pdf-bg-yellow">
                                  <td className="border p-3 font-black text-left pl-6 uppercase pdf-text-red">
                                      {lang === 'SI' ? `${reportData.currMonthNameSI} සාමාන්‍යය` : `${reportData.currMonthNameEN} AVERAGE`}
                                  </td>
                                  <td className="border p-3 font-black pdf-text-red">{reportData.currentStats.avgBest}</td>
                                  <td className="border p-3 font-black pdf-text-red">{reportData.currentStats.avgBelow}</td>
                                  <td className="border p-3 font-black pdf-text-red">{reportData.currentStats.avgPoor}</td>
                              </tr>
                          )}
                          {reportData && (
                              <tr className="pdf-bg-light">
                                  <td className="border p-3 font-black text-left pl-6 uppercase" style={{ color: '#be123c' }}>
                                      {lang === 'SI' ? `${reportData.prevMonthNameSI} සාමාන්‍යය` : `${reportData.prevMonthNameEN} AVERAGE`}
                                  </td>
                                  <td className="border p-3 font-black" style={{ color: '#be123c' }}>{reportData.prevStats.avgBest}</td>
                                  <td className="border p-3 font-black" style={{ color: '#be123c' }}>{reportData.prevStats.avgBelow}</td>
                                  <td className="border p-3 font-black" style={{ color: '#be123c' }}>{reportData.prevStats.avgPoor}</td>
                              </tr>
                          )}
                      </tbody>
                  </table>
