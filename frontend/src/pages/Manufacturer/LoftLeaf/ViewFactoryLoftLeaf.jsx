  ...
  const generatePDFForDate = async () => {
    ...
    try {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            pdf.text(`Page ${i} of ${pageCount} - Generated by Unified Management System`, pdfPageWidth / 2, pdfPageHeight - 15, { align: 'center' });
        }
      ...
      try {
          ...
          if (format === 'pdf') {
              ...
              for (let i = 1; i <= pageCount; i++) {
                  ...
                  pdf.setFontSize(8);
                  pdf.setTextColor(128, 128, 128);
                  pdf.text(`Page ${i} of ${pageCount} - Generated by Unified Management System`, pdfWidth / 2, actualPageHeight - 15, { align: 'center' });
              }
