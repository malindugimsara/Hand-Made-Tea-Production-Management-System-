      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5 md:gap-6">
          <div className="flex flex-col items-start text-left w-full">
            ...
            {/* Subtitle */}
            <p className="text-xs sm:text-sm md:text-base font-medium text-white/85 max-w-full sm:max-w-md md:max-w-2xl drop-shadow-sm leading-relaxed">
              {getGreeting()}! Here you can monitor the factory's daily operations, track production metrics, and stay updated with real-time alerts to ensure smooth manufacturing processes.
            </p>
          </div>
        </div>
      </div>
